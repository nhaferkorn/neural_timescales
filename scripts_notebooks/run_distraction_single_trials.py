...
event_high_dist_left = {k: EVENT_DICT[k] for k in key_high_dist_left}
event_high_dist_right = {k: EVENT_DICT[k] for k in key_high_dist_right}
event_low_dist_left = {k: EVENT_DICT[k] for k in key_low_dist_left}
event_low_dist_right = {k: EVENT_DICT[k] for k in key_low_dist_right}
...
## FIT TIMESCALES ON LEFT TRIALS HIGH DISTRACTION 
acf_trials_high_left, rsq_trials_high_left = timescales_acf_single_trials(sub=sub, epochs = , osc=False)
