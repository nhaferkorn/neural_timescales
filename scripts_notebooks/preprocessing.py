...
FIND_EOGs = False
RUN_ICA = True # Run once per subject, then ICA solution is saved
APPLY_ICA = True 
RUN_EPOCHS = False
...
def preprocessing(sub):
    ...
    if RUN_ANNOTATIONS:
        ...
        # Annotate rest periods - TO BE FIXED
        ...
        # okay, this works; but is definitely not the most elegant solution 
    ...
    if APPLY_ICA:
        ...
        # plot the signal after applying ICA and removal of blink components 
